...
def create_pipe():
    ...
    top_pipe = pipe_surface.get_rect(midtop=(800, random_pipe_pos - 450))
...
bird_rect = bird.get_rect(center=(80, 300))
...
game_over_rect = game_over_surface.get_rect(center=(400, 250))
#Chèn âm thanh
